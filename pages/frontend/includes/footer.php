    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-4">
                <h3>About Us</h3>
                <p class="mb-4">
                    <img src="assets/frontend/images/img_1.jpg" alt="Image placeholder" class="img-fluid">
                </p>
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="post-entry-sidebar">
                            <ul>
                                <li>
                                    <a href="">
                                        <img src="assets/frontend/images/img_6.jpg" alt="Image placeholder" class="mr-4">
                                        <div class="text">
                                ...
                                <li>
                                    <a href="">
                                        <img src="assets/frontend/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                                        <div class="text">
                                            <h4>How to Find the Video Games of Your Youth</h4>
                                            <div class="post-meta">
                                                <span class="mr-2">March 15, 2018 </span> &bullet;
...
<script src="assets/frontend/js/jquery-migrate-3.0.0.js"></script>
