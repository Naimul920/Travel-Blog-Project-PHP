...
<!-- Mirrored from themesbrand.com/minible/layouts/auth-recoverpw.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jul 2021 13:45:16 GMT -->
<head>
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div>
                    ...
                    <a href="" class="mb-5 d-block auth-logo">
                        <img src="" alt="" height="22" class="logo logo-dark">
                        <img src="" alt="" height="22" class="logo logo-light">
                    </a>
                    <div class="card">
                            ...
                            <?php } ?>
                                ...
                                <form action="action.php" method="post">
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">Remember It ? <a href="action.php?status=login" class="fw-medium text-primary"> Signin </a></p>
                                    </div>
                                </form>
                            </div>
